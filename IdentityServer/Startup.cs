...
namespace IdentityServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            const string connectionString = @"Server=(localdb)\\mssqllocaldb;Database=aspnet-MyIdentityServer-68649070-5663-422D-B2A8-75B9085C6E92;Trusted_Connection=True;MultipleActiveResultSets=true";
            ...
            var builder = services.AddIdentityServer()
                ...
                {
                    options.ConfigureDbContext = b => b.UseSqlServer(DbContextConnStr,
